...
def admin_dashboard_view(request):
    ...
    dict={
        ...
        'totalrequest':models.PlateletRequest.objects.all().count(),
        'totalapprovedrequest':models.PlateletRequest.objects.all().filter(status='Approved').count()
    }
...
def approve_donation_view(request,pk):
    donation=dmodels.PlateletDonate.objects.get(id=pk)
